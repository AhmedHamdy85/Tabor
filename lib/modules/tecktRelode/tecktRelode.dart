                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: specialtext(text: 'تفاصيل التذكرة',
                              fsize: 21,
                        ...
                        Center(
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  specialtext(text: 'الانتظار',
                                  fweight: FontWeight.w500,
                                  fsize: 18
                                  ),
                                  Spacer(),
                                  specialtext(text:'18 ساعه',
                                  fweight: FontWeight.w500,
                                  fsize: 18,
                                  ),
                                ],
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                specialtext(text: "تاريخ التذكرة",
                                fweight: FontWeight.w500
                                ),
                                const SizedBox(height: 16,),
                                specialtext(text: "الوقت",
                                fweight: FontWeight.w500,
                            ...
                            Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.end,
                              children: [
                                specialtext(text: "2 مارس ,2023",
                                fweight: FontWeight.w500
                                ),
                                const SizedBox(height: 16,),
                                specialtext(text: "11:28 AM",
                                fweight: FontWeight.w500,
                                fcolor:  const Color(0xff7d7d7d),
                                ),
                              ],
